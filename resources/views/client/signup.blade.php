			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="{{url('/creer_compte')}}" method="POST" id="contactForm" novalidate="novalidate">
							@if (Session::has('status'))
							<div class="col-lg-12 justify-content-center alert alert-success">
							  {{Session::get('status')}}
					</div>
						   @endif
						   @if (count($errors) >0)
						   ...
						   @endif
							...
							<div class="col-md-12 form-group">
								...
								<a href="{{url('client_login')}}">Have an account?</a>
							</div>
						</form>
					</div>
				</div>
